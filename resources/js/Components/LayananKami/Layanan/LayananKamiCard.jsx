...
const LayananKamiCard = ({ title, image, body }) => {
  return (
    <div className='w-[20rem] md:w-[40rem] lg:w-[45rem]  m-auto shadow-lg rounded-lg font-inter md:flex bg-white'>
          ...
          <div className='py-4 px-6'>
              ...
              <div className='flex justify-between'>
                  ...
                  <button className='text-white  text-sm bg-[#24A0ED] py-2 px-3 font-semibold rounded-lg mb-1'> <Link to="/"> Selengkapnya</Link> </button>
              </div>
          </div>
      </div>
